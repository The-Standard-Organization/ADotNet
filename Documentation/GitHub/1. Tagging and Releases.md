...
4. **Select Fine-grained access tokens**: Under the Developer settings, click on "Fine-grained tokens" to manage your access tokens.
...
You can choose to grant access to all repositories, select individual repositories, or select repositories by organisation. 
    ...
    ![image](https://github.com/hassanhabib/ADotNet/assets/797750/3f806a86-99cb-4f07-9b2d-edbd5efc1c39)
...
For tagging we only require the following permissions:
    ...
    ![image](https://github.com/hassanhabib/ADotNet/assets/797750/c44413c5-7ffc-41bc-b828-d74e74123747)


12. **Generate the token**: Once the configuration options has been set for the token, click on the "Generate token" button.

    ![image](https://github.com/hassanhabib/ADotNet/assets/797750/b7dded9c-9bd0-401f-b4a1-dc838d68400a)
