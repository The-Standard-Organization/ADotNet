...
namespace ADotNet.Clients.Builders
{
    ...
    public class JobBuilderV2
    {
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddGenericStep(string name, string runCommand)
        {
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 DependsOn(params string[] jobNames)
        {
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 WithCondition(string condition)
        {
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddMatrix(
            string variable,
            params string[] values)
        {
            this.job.Strategy ??= new StrategyV2();
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddMatrixInclude(Dictionary<string, string> include)
        {
            this.job.Strategy ??= new StrategyV2();
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddMatrixExclude(Dictionary<string, string> exclude)
        {
            this.job.Strategy ??= new StrategyV2();
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 WithFailFast(bool failFast)
        {
            this.job.Strategy ??= new StrategyV2();
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 WithMaxParallel(int maxParallel)
        {
            this.job.Strategy ??= new StrategyV2();
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddActionStep(
            string name,
            string uses,
            string id = null,
        ...
        /// <returns>The current instance of <see cref="JobBuilderV2"/>.</returns>
        public JobBuilderV2 AddService(string id, Service service)
        {
